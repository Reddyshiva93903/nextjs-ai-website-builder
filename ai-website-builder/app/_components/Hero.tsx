...
function Hero() {
  ...
  return (
    <div className='flex flex-col items-center h-[80vh] justify-center'>
      {/* Header & description */}
      <h2 className='font-bold text-6xl'>What would you like to design today?</h2>
      <p className='mt-2 text-xl text-gray-500'>Create, customize, and explore designs with AI</p>
